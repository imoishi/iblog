                ...
                beautiful user</span> interfaces with love.</h3>
                    ...
                    <div class="about-pic-grids row no-gutters mt-5">
                        <div class="col-md-3 position-relative person-img">
                            <img src="{{asset('/')}}assets/frontend/images/person.jpg" alt="" class="radius-image img-fluid">
                        </div>
        ...
        <div class="row gallery_grids no-gutters">
            <div class="col-lg-4 col-6 gallery-img-grid gallery_grid1 hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g1.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g1.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6 gallery-img-grid hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g2.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g2.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6 gallery-img-grid hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g3.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g3.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6 gallery-img-grid hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g4.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g4.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6 gallery-img-grid hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g5.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g5.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
            <div class="col-lg-4 col-6 gallery-img-grid hover14 column">
                <div class="gallery_effect">
                    <a href="{{asset('/')}}assets/frontend/images/g6.jpg" class="js-img-viwer d-block">
                        <figure>
                            <img src="{{asset('/')}}assets/frontend/images/g6.jpg" alt=" " class="img-fluid" />
                        </figure>
                    </a>
                </div>
            </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{asset('/')}}assets/frontend/images/c1.jpg" class="img-fluid" alt="client-img">
                                    </div>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{asset('/')}}assets/frontend/images/c2.jpg" class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Julia sakura</h3>
                                        <p class="indentity">Seattle, Washington</p>
                    ...
                    <div class="item">
                        <div class="testimonial-content">
                            <div class="testimonial">
                                ...
                                <div class="testi-des">
                                    <div class="test-img"><img src="{{asset('/')}}assets/frontend/images/c3.jpg" class="img-fluid" alt="client-img">
                                    </div>
                                    <div class="peopl align-self">
                                        <h3>Roy Linderson</h3>
                                        <p class="indentity">Seattle, Washington</p>
