        ...
        <div class="container py-lg-5 py-md-4 py-2">
            <div class="row">
                ...
                <div class="col-lg-4 left-wthree-img mt-lg-0 mt-md-5 mt-4">
                    <img src="{{asset('/')}}assets/frontend/images/person1.jpg" alt="" class="radius-image img-fluid">
                </div>
        ...
        <div class="container py-lg-5 py-md-3 py-2">
            ...
            <div class="row circle-grids">
                ...
                <div class="col-lg-6 circle-img-right mt-lg-0 mt-5 pl-lg-5 p-lg-4">
                    <img src="{{asset('/')}}assets/frontend/images/banner1.jpg" alt="" class="radius-image img-fluid">
                </div>
            </div>
...
@push('script')
    <script src="{{asset('/')}}assets/frontend/js/circles.js"></script>
@endpush
