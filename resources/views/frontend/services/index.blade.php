            ...
            <div class="grids-of-5 row mt-5 text-center">
                <div class="col-lg-4 col-md-6">
                    <div class="grids5-info">
                        <a href="#service" class="d-block zoom"><img src="{{asset('/')}}assets/frontend/images/s1.jpg" alt="" class="img-fluid radius-image"></a>
                        <div class="blog-info">
                ...
                <div class="col-lg-4 col-md-6 mt-md-0 mt-sm-5 mt-4">
                    <div class="grids5-info">
                        <a href="#service" class="d-block zoom"><img src="{{asset('/')}}assets/frontend/images/s2.jpg" alt="" class="img-fluid radius-image"></a>
                        <div class="blog-info">
                ...
                <div class="col-lg-4 col-md-6 mt-lg-0 mt-sm-5 mt-4">
                    <div class="grids5-info">
                        <a href="#service" class="d-block zoom"><img src="{{asset('/')}}assets/frontend/images/s3.jpg" alt="" class="img-fluid radius-image"></a>
                        <div class="blog-info">
